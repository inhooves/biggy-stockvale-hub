          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            ...
            <div>
              ...
              <div className="flex flex-col gap-1.5 md:gap-2 text-xs md:text-sm text-muted-foreground">
                ...
                <a href="https://wa.me/263715385960" target="_blank" rel="noopener noreferrer" className="hover:text-primary">+263 715 385 960</a>
                <a href="https://wa.me/263713360948" target="_blank" rel="noopener noreferrer" className="hover:text-primary">+263 713 360 948</a>
                <a href="https://wa.me/263773226245" target="_blank" rel="noopener noreferrer" className="hover:text-primary">+263 773 226 245</a>
              </div>
            </div>
            <div className="col-span-2 md:col-span-1">
